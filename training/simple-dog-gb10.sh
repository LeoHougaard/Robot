...
start_training() {
  ...
  [[ "$terrain" == flat || "$terrain" == rough || "$terrain" == rough_noscan ||
     ...
     "$terrain" == currentbodyv15hard || "$terrain" == currentbodyv16hard ||
     "$terrain" == currentbodyv17hard || "$terrain" == currentbodyv18hard ||
     "$terrain" == currentbodyv19hard || "$terrain" == currentbodyv20train || "$terrain" == currentbodyv21acquire || "$terrain" == currentbodyv21commands || "$terrain" == currentbodyv22acquire || "$terrain" == currentbodyv22commands || "$terrain" == currentbodyv22speed || "$terrain" == currentbodyv22rough125 || "$terrain" == currentbodyv22roughbumps25 || "$terrain" == currentbodyv22stairs || "$terrain" == currentbodyv22variedlift ]] ||
    { printf 'Invalid terrain: %s\n' "$terrain" >&2; exit 2; }
  [[ "$terrain" != v2robust && "$terrain" != v2goal && "$terrain" != currentbodyv22rough125 && "$terrain" != currentbodyv22roughbumps25 && "$terrain" != currentbodyv22stairs && "$terrain" != currentbodyv22variedlift &&
