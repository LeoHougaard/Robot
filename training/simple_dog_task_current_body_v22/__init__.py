...
for stage, env, cfg in (("Acquire", "StrideEnv", "CadStrideAcquireCfg"),
                        ...
                        ("VariedLift", "StrideCommandEnv", "CadStrideVariedLiftCfg")):
    gym.register(
        ...
        kwargs={"env_cfg_entry_point": f"{__name__}.env_cfg:{cfg}",
                "rl_games_cfg_entry_point": (f"{__name__}.agents:rl_games_ppo_highlift_cfg.yaml"
                                            if stage == "VariedLift"
                                            else f"{__name__}.agents:rl_games_ppo_cfg.yaml")},
    )
