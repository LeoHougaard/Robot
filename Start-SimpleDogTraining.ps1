...
$v22Terrains = @("CurrentBodyV22Acquire", "CurrentBodyV22Commands", "CurrentBodyV22Speed", "CurrentBodyV22Rough125")
...
if ($Terrain -eq "CurrentBodyV22Rough125" -and -not $Checkpoint) {
