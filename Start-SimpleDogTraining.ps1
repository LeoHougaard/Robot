...
$currentBodyTerrains = $v4Terrains + $v5Terrains + $v6Terrains + $v7Terrains + $v8Terrains + $v9Terrains + $v10Terrains + $v11Terrains + $v12Terrains
if (($isV4Terrain -or $isV5Terrain -or $isV6Terrain -or $isV7Terrain -or $isV8Terrain -or $isV9Terrain -or $isV10Terrain -or $isV11Terrain -or $isV12Terrain) -and $Checkpoint) {
...
if ($Terrain -in ($currentTerrains + $currentBodyTerrains)) {
    ...
    $fitFamily = if ($isV5Terrain -or $isV6Terrain -or $isV7Terrain -or $isV8Terrain -or $isV9Terrain -or $isV10Terrain -or $isV11Terrain -or $isV12Terrain) {
        "current-body-v5"
    }
    elseif ($isV4Terrain) {
        "current-body-v4"
