...
$v22Terrains = @("CurrentBodyV22Acquire", "CurrentBodyV22Commands", "CurrentBodyV22Speed", "CurrentBodyV22Rough125", "CurrentBodyV22RoughBumps25")
...
if ($Terrain -in @("CurrentBodyV22Rough125", "CurrentBodyV22RoughBumps25") -and -not $Checkpoint) {
